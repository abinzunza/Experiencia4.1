...
* @Last Modified by: Abigail Inzunza Lorca
...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
    ...
    buttons: [
      {
        text: '<i class="glyphicon glyphicon-plus"></i> Agregar película',
          ...
          bootbox.dialog({
            ...
            '<div class="form-group">' +
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="agregar_codigo" class="form-control" placeholder="Fecha de Estreno" required>' +
              '</div>' +
            '</div>' +
            ...
            '<div class="form-group">' +
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="agregar_nombre" class="form-control" placeholder="Nombre de película" required>' +
              '</div>' +
            '</div>'+
            ...
            '<div class="input-group">' +
                '<span class="input-group-addon">' +
                  '<i class="glyphicon glyphicon-tag"></i>' +
                '</span>' +
                '<input type="text" id="agregar_genero" class="form-control" placeholder="Género" required>' +
              '</div>' +
            ...
            '<div class="input-group">' +
                '<span class="input-group-addon">' +
                  '<i class="glyphicon glyphicon-tag"></i>' +
                '</span>' +
                '<input type="text" id="agregar_sinopsis" class="form-control" placeholder="Sinópsis" required>' +
              '</div>',
    ...
    columns: [
      {data: 'codigo', title: 'Fecha Estreno'},
